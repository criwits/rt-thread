...
/* Function: main
   ...
   identical 
        3 - third seed  : Any value, should be at least an order of
   magnitude less then the input size, but bigger then 32. 
        4 - Iterations  : Special, if set to 0, iterations will be automatically determined such that
...
MSH_CMD_EXPORT(coremark_main, Run Coremark with default arguments)
